...
class DayFourSpec extends FlatSpec with Matchers {
  "DayFour validateDistinct" should "validate strings with all unique words" in {
  ...
  "DayFour validateAnagrams" should "validate passphrase with unique characters" in {
